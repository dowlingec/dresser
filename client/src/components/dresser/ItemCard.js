...
function ItemCard({item, setDeleteItem, deleteItem, outfits, setNewItem}) {
  ...
  return(
    <div className="item">
      ...
      <AddToOutfit outfitSelectVisible={outfitSelectVisible} setOutfitSelectVisible={setOutfitSelectVisible} item={item} outfits={outfits} setNewItem={setNewItem}/>
